...
$(TMP_TOP)/$(MODE)/$(TMP_DEP)/$(PKG_DIR)/cli/$(SRC_DIR)/%.cpp.d : $(PKG_DIR)/cli/$(SRC_DIR)/%.cpp
	@if [ ! -d $(dir $@) ]; then \
		mkdir -p $(dir $@); \
	fi
	$(AT)rm -f $@
...
$(TMP_TOP)/$(MODE)/$(TMP_DEP)/$(PKG_DIR)/cli/$(SRC_DIR)/%.c.d : $(PKG_DIR)/cli/$(SRC_DIR)/%.c
	@if [ ! -d $(dir $@) ]; then \
		mkdir -p $(dir $@); \
	fi
	$(AT)rm -f $@
...
$(TMP_TOP)/$(MODE)/$(TMP_OBJ)/$(TMP_STA)/$(PKG_DIR)/cli/$(SRC_DIR)/%.cpp.o : $(PKG_DIR)/cli/$(SRC_DIR)/%.cpp
	@if [ ! -d $(dir $@) ]; then \
		mkdir -p $(dir $@); \
	fi
	$(AT)rm -f $@
...
$(TMP_TOP)/$(MODE)/$(TMP_OBJ)/$(TMP_STA)/$(PKG_DIR)/cli/$(SRC_DIR)/%.c.o : $(PKG_DIR)/cli/$(SRC_DIR)/%.c
	@if [ ! -d $(dir $@) ]; then \
		mkdir -p $(dir $@); \
	fi
	$(AT)rm -f $@
...
$(TMP_TOP)/$(MODE)/$(TMP_OBJ)/$(TMP_DYN)/$(PKG_DIR)/cli/$(SRC_DIR)/%.cpp.o : $(PKG_DIR)/cli/$(SRC_DIR)/%.cpp
	@if [ ! -d $(dir $@) ]; then \
		mkdir -p $(dir $@); \
	fi
	$(AT)rm -f $@
...
$(TMP_TOP)/$(MODE)/$(TMP_OBJ)/$(TMP_DYN)/$(PKG_DIR)/cli/$(SRC_DIR)/%.c.o : $(PKG_DIR)/cli/$(SRC_DIR)/%.c
	@if [ ! -d $(dir $@) ]; then \
		mkdir -p $(dir $@); \
	fi
	$(AT)rm -f $@
...
$(TMP_TOP)/$(MODE)/$(TMP_DEP)/$(PKG_DIR)/interface/$(SRC_DIR)/%.cpp.d : $(PKG_DIR)/interface/$(SRC_DIR)/%.cpp
	@if [ ! -d $(dir $@) ]; then \
		mkdir -p $(dir $@); \
	fi
	$(AT)rm -f $@
...
$(TMP_TOP)/$(MODE)/$(TMP_DEP)/$(PKG_DIR)/interface/$(SRC_DIR)/%.c.d : $(PKG_DIR)/interface/$(SRC_DIR)/%.c
	@if [ ! -d $(dir $@) ]; then \
		mkdir -p $(dir $@); \
	fi
	$(AT)rm -f $@
...
$(TMP_TOP)/$(MODE)/$(TMP_OBJ)/$(TMP_STA)/$(PKG_DIR)/interface/$(SRC_DIR)/%.cpp.o : $(PKG_DIR)/interface/$(SRC_DIR)/%.cpp
	@if [ ! -d $(dir $@) ]; then \
		mkdir -p $(dir $@); \
	fi
	$(AT)rm -f $@
...
$(TMP_TOP)/$(MODE)/$(TMP_OBJ)/$(TMP_STA)/$(PKG_DIR)/interface/$(SRC_DIR)/%.c.o : $(PKG_DIR)/interface/$(SRC_DIR)/%.c
	@if [ ! -d $(dir $@) ]; then \
		mkdir -p $(dir $@); \
	fi
	$(AT)rm -f $@
...
$(TMP_TOP)/$(MODE)/$(TMP_OBJ)/$(TMP_DYN)/$(PKG_DIR)/interface/$(SRC_DIR)/%.cpp.o : $(PKG_DIR)/interface/$(SRC_DIR)/%.cpp
	@if [ ! -d $(dir $@) ]; then \
		mkdir -p $(dir $@); \
	fi
	$(AT)rm -f $@
...
$(TMP_TOP)/$(MODE)/$(TMP_OBJ)/$(TMP_DYN)/$(PKG_DIR)/interface/$(SRC_DIR)/%.c.o : $(PKG_DIR)/interface/$(SRC_DIR)/%.c
	@if [ ! -d $(dir $@) ]; then \
		mkdir -p $(dir $@); \
	fi
	$(AT)rm -f $@
