...
$(TMP_TOP)/$(MODE)/$(TMP_QT)/$(PKG_DIR)/cli/$(INC_DIR)/%.h.cpp : $(PKG_DIR)/cli/$(INC_DIR)/%.h
	@if [ ! -d $(dir $@) ]; then \
		mkdir -p $(dir $@); \
	fi
	$(AT)rm -f $@
	@echo "    MOC $(notdir $@) $(PRT_MODE)"
	$(AT)$(MOC) $(if $(PKG_cli_MODE_$(MODE)_MOC_FLAGS),$(PKG_cli_MODE_$(MODE)_MOC_FLAGS),$(if $(PKG_cli_MOC_FLAGS),$(PKG_cli_MOC_FLAGS),$(if $(MODE_$(MODE)_MOC_FLAGS),$(MODE_$(MODE)_MOC_FLAGS),$(CMN_MOC_FLAGS)))) -p cli/$(INC_DIR) -o $@ $<

$(TMP_TOP)/$(MODE)/$(TMP_DEP)/$(PKG_DIR)/cli/$(INC_DIR)/%.cpp.d : $(TMP_TOP)/$(MODE)/$(TMP_QT)/$(PKG_DIR)/cli/$(INC_DIR)/%.cpp
	@if [ ! -d $(dir $@) ]; then \
		mkdir -p $(dir $@); \
	fi
	$(AT)rm -f $@
...
$(TMP_TOP)/$(MODE)/$(TMP_OBJ)/$(TMP_STA)/$(PKG_DIR)/cli/$(INC_DIR)/%.cpp.o : $(TMP_TOP)/$(MODE)/$(TMP_QT)/$(PKG_DIR)/cli/$(INC_DIR)/%.cpp
	@if [ ! -d $(dir $@) ]; then \
		mkdir -p $(dir $@); \
	fi
	$(AT)rm -f $@
...
$(TMP_TOP)/$(MODE)/$(TMP_OBJ)/$(TMP_DYN)/$(PKG_DIR)/cli/$(INC_DIR)/%.cpp.o : $(TMP_TOP)/$(MODE)/$(TMP_QT)/$(PKG_DIR)/cli/$(INC_DIR)/%.cpp
	@if [ ! -d $(dir $@) ]; then \
		mkdir -p $(dir $@); \
	fi
	$(AT)rm -f $@
...
$(TMP_TOP)/$(MODE)/$(TMP_QT)/$(PKG_DIR)/interface/$(INC_DIR)/%.h.cpp : $(PKG_DIR)/interface/$(INC_DIR)/%.h
	@if [ ! -d $(dir $@) ]; then \
		mkdir -p $(dir $@); \
	fi
	$(AT)rm -f $@
	@echo "    MOC $(notdir $@) $(PRT_MODE)"
	$(AT)$(MOC) $(if $(PKG_interface_MODE_$(MODE)_MOC_FLAGS),$(PKG_interface_MODE_$(MODE)_MOC_FLAGS),$(if $(PKG_interface_MOC_FLAGS),$(PKG_interface_MOC_FLAGS),$(if $(MODE_$(MODE)_MOC_FLAGS),$(MODE_$(MODE)_MOC_FLAGS),$(CMN_MOC_FLAGS)))) -p interface/$(INC_DIR) -o $@ $<

$(TMP_TOP)/$(MODE)/$(TMP_DEP)/$(PKG_DIR)/interface/$(INC_DIR)/%.cpp.d : $(TMP_TOP)/$(MODE)/$(TMP_QT)/$(PKG_DIR)/interface/$(INC_DIR)/%.cpp
	@if [ ! -d $(dir $@) ]; then \
		mkdir -p $(dir $@); \
	fi
	$(AT)rm -f $@
...
$(TMP_TOP)/$(MODE)/$(TMP_OBJ)/$(TMP_STA)/$(PKG_DIR)/interface/$(INC_DIR)/%.cpp.o : $(TMP_TOP)/$(MODE)/$(TMP_QT)/$(PKG_DIR)/interface/$(INC_DIR)/%.cpp
	@if [ ! -d $(dir $@) ]; then \
		mkdir -p $(dir $@); \
	fi
	$(AT)rm -f $@
...
$(TMP_TOP)/$(MODE)/$(TMP_OBJ)/$(TMP_DYN)/$(PKG_DIR)/interface/$(INC_DIR)/%.cpp.o : $(TMP_TOP)/$(MODE)/$(TMP_QT)/$(PKG_DIR)/interface/$(INC_DIR)/%.cpp
	@if [ ! -d $(dir $@) ]; then \
		mkdir -p $(dir $@); \
	fi
	$(AT)rm -f $@
